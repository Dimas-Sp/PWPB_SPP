                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="250">
                                            ...
                                            <a onclick="deleteConfirm('<?php echo site_url('admin/kelas/delete'.$ikelas->id_kelas) ?>')"
                                             href="<?php echo site_url('admin/kelas/delete/'.$ikelas->id_kelas) ?>" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
